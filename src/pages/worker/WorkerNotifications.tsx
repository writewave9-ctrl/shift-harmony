              ...
              <MotionItem key={notification.id} index={index}>
                <MotionCard
                  ...
                  className={cn(
                    ...
                    notification.read ? 'bg-card hover:bg-accent/50' : 'bg-primary/5 border border-primary/20 hover:bg-primary/10'
                  )}
                >
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        <p className={cn('font-medium text-foreground', !notification.read && 'font-semibold')}>{notification.title}</p>
