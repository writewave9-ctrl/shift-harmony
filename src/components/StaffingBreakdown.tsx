 ...
 */
export const StaffingBreakdown: React.FC<Props> = ({ shifts, className }) => {
      ...
      <ul className="px-5 pb-5 space-y-2">
        {gaps.map((g) => {
          ...
          return (
            <li
              key={g.position}
              className="flex items-start justify-between gap-3 rounded-xl bg-warning-muted/40 ring-1 ring-warning/15 px-3.5 py-3"
            >
